...
//
// Per-spec identity
:doc-topic: Reader Definitions
:doc-name: Terminal Reader Definitions API
:doc-type: Specification
:doc-classification: Public
:doc-id: CNA-TRD-API
:doc-ref: YYMMDD-SP-CNATerminalAPI-ReaderDefinitions
:doc-repo: https://github.com/calypsonet/calypsonet-terminal-reader-definitions-uml-api
...
| `reader.definitions` | Public API
| Shared vocabulary of the Terminal Reader API: the RF-technology and card-type enumerations (`RfTechnology`,
...
----
include::uml/class-diagram.puml[Terminal Reader Definitions API class diagram]
----
...
[[type_ReaderDefinitionsApiProperties]]
==== Reader Definitions API Properties

[cols="^.^1h,.^5", grid=rows, frame=all]
|===
| Name       | `ReaderDefinitionsApiProperties`
| Kind       | Constants
| Namespace  | `reader.definitions`
| Since      | 1.0
